                ...
                {properties.map((property, index) => {
                    return(
                        <Col key={index} className="mb-5">
                            <Card className="p-3">
                                <Card.Img variant="top" className="mb-3" src={process.env.PUBLIC_URL + property.url} />
                                <Card.Title><h3 style={{fontWeight:"bold"}}>{property.name}</h3></Card.Title>
                                ...
                                {
                                    {
                                        ...
                                        <Fragment>
                                            <ButtonGroup>
                                                ...
                                                <Button className="mb-1" size="sm" variant="outline-primary" onClick={() => handleDelete(property._id)}>Delete</Button>
                                            </ButtonGroup>                                            
                                        </Fragment>
                                    }[isAdmin]
                                }
